...
`;function Ly(){const r=Ut();return r.selected?f.jsx(hu,{id:r.productId}):f.jsxs(f.Fragment,{children:[f.jsxs(Ry,{children:[f.jsx("h4",{children:"NEW PRODUCT"}),f.jsx("p",{className:"productName",children:"XX99 MARK ll HEADPHONES"}),f.jsx("p",{children:"Experience natural, lifelike audio and exceptional build quality made for the passionate music enthusiast."}),f.jsx(Kt,{className:"newProductButton",children:"SEE PRODUCT"})]}),f.jsxs(Ms,{bgImage:"./assets/product-xx99-mark-two-headphones/desktop/image-product.jpg",children:[f.jsx("div",{className:"headphone-image"}),f.jsxs("div",{className:"info",children:[f.jsx("p",{className:"anonce",children:"NEW PRODUCT"}),f.jsx("p",{className:"product-name",children:"XX99 MARK II HEADPHONES"}),f.jsx("p",{className:"prod-desc",children:"The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound."}),f.jsx(Kt,{className:"seeButton",onClick:()=>{r.setProductId(4),r.setProductSelected(!0)},children:"SEE PRODUCT"})]})]}),f.jsxs(Ms,{bgImage:"./assets/product-xx99-mark-one-headphones/desktop/image-product.jpg",children:[f.jsxs("div",{className:"info",children:[f.jsx("p",{className:"product-name",children:"XX99 MARK I HEADPHONES"}),f.jsx("p",{className:"prod-desc",children:"The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound."}),f.jsx(Kt,{className:"seeButton",onClick:()=>{r.setProductId(3),r.setProductSelected(!0)},children:"SEE PRODUCT"})]}),f.jsx("div",{className:"headphone-image"})]}),f.jsxs(Ms,{bgImage:"./assets/product-xx59-headphones/desktop/image-product.jpg",children:[f.jsx("div",{className:"headphone-image"}),f.jsxs("div",{className:"info",children:[f.jsx("p",{className:"product-name",children:"XX59 HEADPHONES"}),f.jsx("p",{className:"prod-desc",children:"The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound."}),f.jsx(Kt,{className:"seeButton",onClick:()=>{r.setProductId(2),r.setProductSelected(!0)},children:"SEE PRODUCT"})]})]})]})}const Ms=ke.div`
    width: 1110px;
    height: 560px;
    display: flex;
    gap: 120px;
...
`;function My(){const r=Ut();return r.selected?f.jsx(hu,{id:r.productId}):f.jsxs(f.Fragment,{children:[f.jsxs(Tp,{bgImage:"./assets/product-zx9-speaker/desktop/image-product.jpg",children:[f.jsx("div",{className:"headphone-image"}),f.jsxs("div",{className:"info",children:[f.jsx("p",{className:"anonce",children:"NEW PRODUCT"}),f.jsx("p",{className:"product-name",children:"ZX9 SPEAKER"}),f.jsx("p",{className:"prod-desc",children:"Upgrade your sound system with the all new ZX9 active speaker. It’s a bookshelf speaker system that offers truly wireless connectivity -- creating new possibilities for more pleasing and practical audio setups."}),f.jsx(Kt,{className:"seeButton",onClick:()=>{r.setProductId(6),r.setProductSelected(!0)},children:"SEE PRODUCT"})]})]}),f.jsxs(Tp,{bgImage:"./assets/product-zx7-speaker/desktop/image-product.jpg",children:[f.jsxs("div",{className:"info",children:[f.jsx("p",{className:"product-name",children:"ZX7 SPEAKER"}),f.jsx("p",{className:"prod-desc",children:"Stream high quality sound wirelessly with minimal loss. The ZX7 bookshelf speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use."}),f.jsx(Kt,{className:"seeButton",onClick:()=>{r.setProductId(5),r.setProductSelected(!0)},children:"SEE PRODUCT"})]}),f.jsx("div",{className:"headphone-image"})]})]})}const Tp=ke.div`
    width: 1110px;
    height: 560px;
    display: flex;
    gap: 120px;
...
`;function C0(){const r=Ut();return f.jsxs("div",{children:[f.jsx(Py,{}),f.jsx(Ag,{}),r.checkOut?f.jsx(p0,{}):f.jsxs("div",{style:{position:"relative"},children:[f.jsx(w0,{}),f.jsx(S0,{})]}),f.jsx(Vy,{})]})}const Xs=By;function j0(){const[r,l]=F.useState(!1),[o,u]=F.useState(0),[c,d]=F.useState(!1),[h,g]=F.useState([{device:Xs[0],quantity:3},{device:Xs[1],quantity:1}]),[x,k]=F.useState(!1),_={devices:Xs,selected:r,productId:o,cart:c,cartContent:h,checkOut:x,setProductSelected:l,setProductId:u,setCart:d,setCartContent:g,setCheckOut:k};return c?(document.body.style.overflow="hidden",document.body.style.width="auto"):document.body.style.overflow="auto",x?document.body.style.backgroundColor="#F1F1F1":document.body.style.backgroundColor="#FFFFFF",f.jsx(f.Fragment,{children:f.jsx(Ff.Provider,{value:_,children:f.jsx(sx,{children:f.jsx(Lg,{children:f.jsxs($r,{path:"/",element:f.jsx(C0,{}),children:[f.jsx($r,{index:!0,element:f.jsx(wy,{})}),f.jsx($r,{path:"headphones",element:f.jsx(Ly,{})}),f.jsx($r,{path:"earphones",element:f.jsx($y,{})}),f.jsx($r,{path:"speakers",element:f.jsx(My,{})})]})})})})})}Hm.createRoot(document.getElementById("root")).render(f.jsx(F.StrictMode,{children:f.jsx(j0,{})}));
