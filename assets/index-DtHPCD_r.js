...
`;function C0(){const r=Ut();return f.jsxs("div",{children:[f.jsx(Py,{}),f.jsx(Ag,{}),r.checkOut?f.jsx(p0,{}):f.jsxs("div",{style:{position:"relative"},children:[f.jsx(w0,{}),f.jsx(S0,{})]}),f.jsx(Vy,{})]})}const Xs=By;function j0(){const[r,l]=F.useState(!1),[o,u]=F.useState(0),[c,d]=F.useState(!1),[h,g]=F.useState([{device:Xs[0],quantity:3},{device:Xs[1],quantity:1}]),[x,k]=F.useState(!1),_={devices:Xs,selected:r,productId:o,cart:c,cartContent:h,checkOut:x,setProductSelected:l,setProductId:u,setCart:d,setCartContent:g,setCheckOut:k};return c?(document.body.style.overflow="hidden",document.body.style.width="auto"):document.body.style.overflow="auto",x?document.body.style.backgroundColor="#F1F1F1":document.body.style.backgroundColor="#FFFFFF",f.jsx(f.Fragment,{children:f.jsx(Ff.Provider,{value:_,children:f.jsx(sx,{basename:"/audiophile/",children:f.jsx(Lg,{children:f.jsxs($r,{path:"/",element:f.jsx(C0,{}),children:[f.jsx($r,{index:!0,element:f.jsx(wy,{})}),f.jsx($r,{path:"headphones",element:f.jsx(Ly,{})}),f.jsx($r,{path:"earphones",element:f.jsx($y,{})}),f.jsx($r,{path:"speakers",element:f.jsx(My,{})})]})})})})})}Hm.createRoot(document.getElementById("root")).render(f.jsx(F.StrictMode,{children:f.jsx(j0,{})}));
