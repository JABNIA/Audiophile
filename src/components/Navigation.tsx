    ...
    return (
        <>
            ...
            <ul>
                ...
                }}><Link to="/headphones">HEADPHONES</Link></li>
                <li onClick={()=> {
                    context.setProductSelected(false)
                    context.setCart(false)
                    context.setCheckOut(false)
                ...
                <li onClick={()=> {
                    ...
                    context.setCart(false)
                    context.setCheckOut(false)
                }}><Link to="/earphones">EARPHONES</Link></li>
            </ul>
            <div onClick={() => context.checkOut ? null : context.setCart(curr => !curr)} style={{cursor: "pointer"}}>
...
const NavigationWrapper = styled.div<{selected:boolean}>`
    width: 1110px;
    height: 90px;
    border-bottom: ${(props) => props.selected ? "0px" : "1px solid rgba(255,255,255,0.5)"};
    display: flex;
